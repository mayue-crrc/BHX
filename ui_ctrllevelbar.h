...
public:
    ...
    QLabel *Ctrl_label_EB1;
    QLabel *Ctrl_label_VALUE;
    QLabel *Ctrl_label_EB3;
    QLabel *Ctrl_label_EB2;
...
"}"));
        ...
        Ctrl_label_P7->setGeometry(QRect(3, 3, 74, 22));
        ...
        Ctrl_label_P6->setGeometry(QRect(3, 25, 74, 22));
        ...
        Ctrl_label_background->setGeometry(QRect(0, 0, 80, 405));
        Ctrl_label_background->setStyleSheet(QString::fromUtf8("background-color: rgb(216, 216, 216);"));
        Ctrl_label_P4 = new QLabel(CtrlLevelBar);
        Ctrl_label_P4->setObjectName(QString::fromUtf8("Ctrl_label_P4"));
        Ctrl_label_P4->setGeometry(QRect(3, 69, 74, 22));
        ...
        Ctrl_label_P5->setGeometry(QRect(3, 47, 74, 22));
        ...
        Ctrl_label_P0->setGeometry(QRect(3, 157, 74, 25));
        ...
        Ctrl_label_P2->setGeometry(QRect(3, 113, 74, 22));
        ...
        Ctrl_label_P3->setGeometry(QRect(3, 91, 74, 22));
        ...
        Ctrl_label_P1->setGeometry(QRect(3, 135, 74, 25));
        ...
        Ctrl_label_N1->setGeometry(QRect(3, 179, 74, 25));
        ...
        Ctrl_label_N2->setGeometry(QRect(3, 201, 74, 25));
        ...
        Ctrl_label_N3->setGeometry(QRect(3, 223, 74, 25));
        ...
        Ctrl_label_N4->setGeometry(QRect(3, 245, 74, 25));
        ...
        Ctrl_label_N5->setGeometry(QRect(3, 267, 74, 25));
        ...
        Ctrl_label_N6->setGeometry(QRect(3, 289, 74, 25));
        ...
        Ctrl_label_N7->setGeometry(QRect(3, 311, 74, 25));
        Ctrl_label_N7->setStyleSheet(QString::fromUtf8("background-color: rgb(38, 50, 89);"));
        Ctrl_label_N7->setAlignment(Qt::AlignCenter);
        Ctrl_label_EB1 = new QLabel(CtrlLevelBar);
        Ctrl_label_EB1->setObjectName(QString::fromUtf8("Ctrl_label_EB1"));
        Ctrl_label_EB1->setGeometry(QRect(3, 333, 74, 25));
        Ctrl_label_EB1->setStyleSheet(QString::fromUtf8("background-color: rgb(38, 50, 89);"));
        Ctrl_label_EB1->setAlignment(Qt::AlignCenter);
        Ctrl_label_VALUE = new QLabel(CtrlLevelBar);
        Ctrl_label_VALUE->setObjectName(QString::fromUtf8("Ctrl_label_VALUE"));
        Ctrl_label_VALUE->setGeometry(QRect(3, 410, 74, 21));
        Ctrl_label_VALUE->setStyleSheet(QString::fromUtf8(""));
        Ctrl_label_VALUE->setAlignment(Qt::AlignCenter);
        Ctrl_label_EB3 = new QLabel(CtrlLevelBar);
        Ctrl_label_EB3->setObjectName(QString::fromUtf8("Ctrl_label_EB3"));
        Ctrl_label_EB3->setGeometry(QRect(3, 355, 74, 25));
        Ctrl_label_EB3->setStyleSheet(QString::fromUtf8("background-color: rgb(38, 50, 89);"));
        Ctrl_label_EB3->setAlignment(Qt::AlignCenter);
        Ctrl_label_EB2 = new QLabel(CtrlLevelBar);
        Ctrl_label_EB2->setObjectName(QString::fromUtf8("Ctrl_label_EB2"));
        Ctrl_label_EB2->setGeometry(QRect(3, 377, 74, 25));
        Ctrl_label_EB2->setStyleSheet(QString::fromUtf8("background-color: rgb(38, 50, 89);"));
        Ctrl_label_EB2->setAlignment(Qt::AlignCenter);
        ...
        Ctrl_label_N6->raise();
        Ctrl_label_N7->raise();
        Ctrl_label_EB1->raise();
        Ctrl_label_VALUE->raise();
        Ctrl_label_EB3->raise();
        Ctrl_label_EB2->raise();
    ...
    void retranslateUi(QWidget *CtrlLevelBar)
    {
        ...
        Ctrl_label_EB1->setText(QApplication::translate("CtrlLevelBar", "EB1", 0, QApplication::UnicodeUTF8));
        Ctrl_label_VALUE->setText(QApplication::translate("CtrlLevelBar", "EB", 0, QApplication::UnicodeUTF8));
        Ctrl_label_EB3->setText(QApplication::translate("CtrlLevelBar", "EB3", 0, QApplication::UnicodeUTF8));
        Ctrl_label_EB2->setText(QApplication::translate("CtrlLevelBar", "EB2", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
