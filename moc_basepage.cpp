...
**
** Created: Fri May 11 08:57:42 2018
...
static const char qt_meta_stringdata_BasePage[] = {
    "BasePage\0\0changePage(int)\0"
};

const QMetaObject BasePage::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_BasePage,
      qt_meta_data_BasePage, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &BasePage::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_BasePage))
...
// SIGNAL 0
void BasePage::changePage(int _t1)
{
