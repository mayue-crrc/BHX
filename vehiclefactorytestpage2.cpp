...
#include "ui_vehiclefactorytestpage2.h"
...
VehicleFactoryTestPage2::VehicleFactoryTestPage2(QWidget *parent) :
    BasePage(parent),
    ui(new Ui::VehicleFactoryTestPage2)
{
    ui->setupUi(this);
}
...
void VehicleFactoryTestPage2::showEvent(QShowEvent *event)
{
    ...
    ui->VehicleFactoryTestPage_button_2car->setStyleSheet(MY_BUTTON_DOWN);
    ui->VehicleFactoryTestPage_button_1car->setStyleSheet(MY_BUTTON_UP);
}

void VehicleFactoryTestPage2::updatePage()
{
    QList<bool> signal;

    signal<<this->database->riomDo1Out1Mc2<<this->database->riomDo1Out2Mc2<<this->database->riomDo1Out3Mc2<<
            this->database->riomDo1Out4Mc2<<this->database->riomDo1Out5Mc2<<this->database->riomDo1Out6Mc2<<
            this->database->riomDo1Out7Mc2<<this->database->riomDo1Out8Mc2<<this->database->riomDo1Out9Mc2<<
            this->database->riomDo1Out10Mc2<<this->database->riomDo1Out11Mc2<<this->database->riomDo1Out13Mc2<<
            this->database->riomDo2Out1Mc2<<this->database->riomDo2Out3Mc2<<this->database->riomDo2Out4Mc2<<
            this->database->riomDo2Out5Mc2<<this->database->riomDo2Out7Mc2<<this->database->riomDo2Out8Mc2<<
            this->database->riomDo2Out12Mc2<<this->database->riomDo1Out2M2<<this->database->riomDo1Out3M2<<
            this->database->riomDo1Out5M2<<this->database->riomDo1Out8M2<<this->database->riomDo1Out9M2<<
            this->database->riomDo1Out10M2;
...
void VehicleFactoryTestPage2::resetPisData()
{
    for(int i = 0; i < buttons.size(); i++)
    {
...
void VehicleFactoryTestPage2::on_VehicleFactoryTestPage_button_back_pressed()
{
    changePage(uVehicleParaSetting);
}

void VehicleFactoryTestPage2::on_VehicleFactoryTestPage_button_1car_pressed()
{
    changePage(uVehicleFactoryTestPage);
}

void VehicleFactoryTestPage2::on_VehicleFactoryTestPage_button_teststart_pressed()
{
    if(this->database->HMiCT_FactoryTest_start_B1)
    {
        ui->VehicleFactoryTestPage_button_teststart->setStyleSheet(MY_BUTTON_UP);
...
void VehicleFactoryTestPage2::on_VehicleFactoryTestPage_button_MCDO1_1_pressed()
{
    if(this->database->HMiCT_FactoryTest_MC2DO1_1)
    {
        ui->VehicleFactoryTestPage_button_MCDO1_1->setStyleSheet(MY_FACTORYTEST_BTN_UP);
        this->database->HMiCT_FactoryTest_MC2DO1_1 = false;
    }else
    {
        ui->VehicleFactoryTestPage_button_MCDO1_1->setStyleSheet(MY_FACTORYTEST_BTN_DOWN);
        this->database->HMiCT_FactoryTest_MC2DO1_1 = true;
    }
}
void VehicleFactoryTestPage2::on_VehicleFactoryTestPage_button_MCDO1_2_pressed()
{
    if(this->database->HMiCT_FactoryTest_MC2DO1_2)
    {
        ui->VehicleFactoryTestPage_button_MCDO1_2->setStyleSheet(MY_FACTORYTEST_BTN_UP);
        this->database->HMiCT_FactoryTest_MC2DO1_2 = false;
    }else
    {
        ui->VehicleFactoryTestPage_button_MCDO1_2->setStyleSheet(MY_FACTORYTEST_BTN_DOWN);
        this->database->HMiCT_FactoryTest_MC2DO1_2 = true;
    }
}

void VehicleFactoryTestPage2::on_VehicleFactoryTestPage_button_MCDO1_3_pressed()
{
    if(this->database->HMiCT_FactoryTest_MC2DO1_3)
    {
        ui->VehicleFactoryTestPage_button_MCDO1_3->setStyleSheet(MY_FACTORYTEST_BTN_UP);
        this->database->HMiCT_FactoryTest_MC2DO1_3 = false;
    }else
    {
        ui->VehicleFactoryTestPage_button_MCDO1_3->setStyleSheet(MY_FACTORYTEST_BTN_DOWN);
        this->database->HMiCT_FactoryTest_MC2DO1_3 = true;
    }
}

void VehicleFactoryTestPage2::on_VehicleFactoryTestPage_button_MCDO1_4_pressed()
{
    if(this->database->HMiCT_FactoryTest_MC2DO1_4)
    {
        ui->VehicleFactoryTestPage_button_MCDO1_4->setStyleSheet(MY_FACTORYTEST_BTN_UP);
        this->database->HMiCT_FactoryTest_MC2DO1_4 = false;
    }else
    {
        ui->VehicleFactoryTestPage_button_MCDO1_4->setStyleSheet(MY_FACTORYTEST_BTN_DOWN);
        this->database->HMiCT_FactoryTest_MC2DO1_4 = true;
    }
}

void VehicleFactoryTestPage2::on_VehicleFactoryTestPage_button_MCDO1_5_pressed()
{
    if(this->database->HMiCT_FactoryTest_MC2DO1_5)
    {
        ui->VehicleFactoryTestPage_button_MCDO1_5->setStyleSheet(MY_FACTORYTEST_BTN_UP);
        this->database->HMiCT_FactoryTest_MC2DO1_5 = false;
    }else
    {
        ui->VehicleFactoryTestPage_button_MCDO1_5->setStyleSheet(MY_FACTORYTEST_BTN_DOWN);
        this->database->HMiCT_FactoryTest_MC2DO1_5 = true;
    }
}

void VehicleFactoryTestPage2::on_VehicleFactoryTestPage_button_MCDO1_6_pressed()
{
    if(this->database->HMiCT_FactoryTest_MC2DO1_6)
    {
        ui->VehicleFactoryTestPage_button_MCDO1_6->setStyleSheet(MY_FACTORYTEST_BTN_UP);
        this->database->HMiCT_FactoryTest_MC2DO1_6 = false;
    }else
    {
        ui->VehicleFactoryTestPage_button_MCDO1_6->setStyleSheet(MY_FACTORYTEST_BTN_DOWN);
        this->database->HMiCT_FactoryTest_MC2DO1_6 = true;
    }
}

void VehicleFactoryTestPage2::on_VehicleFactoryTestPage_button_MCDO1_7_pressed()
{
    if(this->database->HMiCT_FactoryTest_MC2DO1_7)
    {
        ui->VehicleFactoryTestPage_button_MCDO1_7->setStyleSheet(MY_FACTORYTEST_BTN_UP);
        this->database->HMiCT_FactoryTest_MC2DO1_7 = false;
    }else
    {
        ui->VehicleFactoryTestPage_button_MCDO1_7->setStyleSheet(MY_FACTORYTEST_BTN_DOWN);
        this->database->HMiCT_FactoryTest_MC2DO1_7 = true;
    }
}

void VehicleFactoryTestPage2::on_VehicleFactoryTestPage_button_MCDO1_8_pressed()
{
    if(this->database->HMiCT_FactoryTest_MC2DO1_8)
    {
        ui->VehicleFactoryTestPage_button_MCDO1_8->setStyleSheet(MY_FACTORYTEST_BTN_UP);
        this->database->HMiCT_FactoryTest_MC2DO1_8 = false;
    }else
    {
        ui->VehicleFactoryTestPage_button_MCDO1_8->setStyleSheet(MY_FACTORYTEST_BTN_DOWN);
        this->database->HMiCT_FactoryTest_MC2DO1_8 = true;
    }
}

void VehicleFactoryTestPage2::on_VehicleFactoryTestPage_button_MCDO1_9_pressed()
{
    if(this->database->HMiCT_FactoryTest_MC2DO1_9)
    {
        ui->VehicleFactoryTestPage_button_MCDO1_9->setStyleSheet(MY_FACTORYTEST_BTN_UP);
        this->database->HMiCT_FactoryTest_MC2DO1_9 = false;
    }else
    {
        ui->VehicleFactoryTestPage_button_MCDO1_9->setStyleSheet(MY_FACTORYTEST_BTN_DOWN);
        this->database->HMiCT_FactoryTest_MC2DO1_9 = true;
    }
}

void VehicleFactoryTestPage2::on_VehicleFactoryTestPage_button_MCDO1_10_pressed()
{
    if(this->database->HMiCT_FactoryTest_MC2DO1_10)
    {
        ui->VehicleFactoryTestPage_button_MCDO1_10->setStyleSheet(MY_FACTORYTEST_BTN_UP);
        this->database->HMiCT_FactoryTest_MC2DO1_10 = false;
    }else
    {
        ui->VehicleFactoryTestPage_button_MCDO1_10->setStyleSheet(MY_FACTORYTEST_BTN_DOWN);
        this->database->HMiCT_FactoryTest_MC2DO1_10 = true;
    }
}

void VehicleFactoryTestPage2::on_VehicleFactoryTestPage_button_MCDO1_11_pressed()
{
    if(this->database->HMiCT_FactoryTest_MC2DO1_11)
    {
        ui->VehicleFactoryTestPage_button_MCDO1_11->setStyleSheet(MY_FACTORYTEST_BTN_UP);
        this->database->HMiCT_FactoryTest_MC2DO1_11 = false;
    }else
    {
        ui->VehicleFactoryTestPage_button_MCDO1_11->setStyleSheet(MY_FACTORYTEST_BTN_DOWN);
        this->database->HMiCT_FactoryTest_MC2DO1_11 = true;
    }
}

void VehicleFactoryTestPage2::on_VehicleFactoryTestPage_button_MCDO1_13_pressed()
{
    if(this->database->HMiCT_FactoryTest_MC2DO1_13)
    {
        ui->VehicleFactoryTestPage_button_MCDO1_13->setStyleSheet(MY_FACTORYTEST_BTN_UP);
        this->database->HMiCT_FactoryTest_MC2DO1_13 = false;
    }else
    {
        ui->VehicleFactoryTestPage_button_MCDO1_13->setStyleSheet(MY_FACTORYTEST_BTN_DOWN);
        this->database->HMiCT_FactoryTest_MC2DO1_13 = true;
    }
}

void VehicleFactoryTestPage2::on_VehicleFactoryTestPage_button_MCDO2_1_pressed()
{
    if(this->database->HMiCT_FactoryTest_MC2DO2_1)
    {
        ui->VehicleFactoryTestPage_button_MCDO2_1->setStyleSheet(MY_FACTORYTEST_BTN_UP);
        this->database->HMiCT_FactoryTest_MC2DO2_1 = false;
    }else
    {
        ui->VehicleFactoryTestPage_button_MCDO2_1->setStyleSheet(MY_FACTORYTEST_BTN_DOWN);
        this->database->HMiCT_FactoryTest_MC2DO2_1 = true;
    }
}

void VehicleFactoryTestPage2::on_VehicleFactoryTestPage_button_MCDO2_3_pressed()
{
    if(this->database->HMiCT_FactoryTest_MC2DO2_3)
    {
        ui->VehicleFactoryTestPage_button_MCDO2_3->setStyleSheet(MY_FACTORYTEST_BTN_UP);
        this->database->HMiCT_FactoryTest_MC2DO2_3 = false;
    }else
    {
        ui->VehicleFactoryTestPage_button_MCDO2_3->setStyleSheet(MY_FACTORYTEST_BTN_DOWN);
        this->database->HMiCT_FactoryTest_MC2DO2_3 = true;
    }
}

void VehicleFactoryTestPage2::on_VehicleFactoryTestPage_button_MCDO2_4_pressed()
{
    if(this->database->HMiCT_FactoryTest_MC2DO2_4)
    {
        ui->VehicleFactoryTestPage_button_MCDO2_4->setStyleSheet(MY_FACTORYTEST_BTN_UP);
        this->database->HMiCT_FactoryTest_MC2DO2_4 = false;
    }else
    {
        ui->VehicleFactoryTestPage_button_MCDO2_4->setStyleSheet(MY_FACTORYTEST_BTN_DOWN);
        this->database->HMiCT_FactoryTest_MC2DO2_4 = true;
    }
}

void VehicleFactoryTestPage2::on_VehicleFactoryTestPage_button_MCDO2_5_pressed()
{
    if(this->database->HMiCT_FactoryTest_MC2DO2_5)
    {
        ui->VehicleFactoryTestPage_button_MCDO2_5->setStyleSheet(MY_FACTORYTEST_BTN_UP);
        this->database->HMiCT_FactoryTest_MC2DO2_5 = false;
    }else
    {
        ui->VehicleFactoryTestPage_button_MCDO2_5->setStyleSheet(MY_FACTORYTEST_BTN_DOWN);
        this->database->HMiCT_FactoryTest_MC2DO2_5 = true;
    }
}

void VehicleFactoryTestPage2::on_VehicleFactoryTestPage_button_MCDO2_7_pressed()
{
    if(this->database->HMiCT_FactoryTest_MC2DO2_7)
    {
        ui->VehicleFactoryTestPage_button_MCDO2_7->setStyleSheet(MY_FACTORYTEST_BTN_UP);
        this->database->HMiCT_FactoryTest_MC2DO2_7 = false;
    }else
    {
        ui->VehicleFactoryTestPage_button_MCDO2_7->setStyleSheet(MY_FACTORYTEST_BTN_DOWN);
        this->database->HMiCT_FactoryTest_MC2DO2_7 = true;
    }
}

void VehicleFactoryTestPage2::on_VehicleFactoryTestPage_button_MCDO2_8_pressed()
{
    if(this->database->HMiCT_FactoryTest_MC2DO2_8)
    {
        ui->VehicleFactoryTestPage_button_MCDO2_8->setStyleSheet(MY_FACTORYTEST_BTN_UP);
        this->database->HMiCT_FactoryTest_MC2DO2_8 = false;
    }else
    {
        ui->VehicleFactoryTestPage_button_MCDO2_8->setStyleSheet(MY_FACTORYTEST_BTN_DOWN);
        this->database->HMiCT_FactoryTest_MC2DO2_8 = true;
    }
}

void VehicleFactoryTestPage2::on_VehicleFactoryTestPage_button_MCDO2_12_pressed()
{
    if(this->database->HMiCT_FactoryTest_MC2DO2_9)
    {
        ui->VehicleFactoryTestPage_button_MCDO2_12->setStyleSheet(MY_FACTORYTEST_BTN_UP);
        this->database->HMiCT_FactoryTest_MC2DO2_9 = false;
    }else
    {
        ui->VehicleFactoryTestPage_button_MCDO2_12->setStyleSheet(MY_FACTORYTEST_BTN_DOWN);
        this->database->HMiCT_FactoryTest_MC2DO2_9 = true;
    }
}

void VehicleFactoryTestPage2::on_VehicleFactoryTestPage_button_MDO1_2_pressed()
{
    if(this->database->HMiCT_FactoryTest_M2DO1_2)
    {
        ui->VehicleFactoryTestPage_button_MDO1_2->setStyleSheet(MY_FACTORYTEST_BTN_UP);
        this->database->HMiCT_FactoryTest_M2DO1_2 = false;
    }else
    {
        ui->VehicleFactoryTestPage_button_MDO1_2->setStyleSheet(MY_FACTORYTEST_BTN_DOWN);
        this->database->HMiCT_FactoryTest_M2DO1_2 = true;
    }
}

void VehicleFactoryTestPage2::on_VehicleFactoryTestPage_button_MDO1_3_pressed()
{
    if(this->database->HMiCT_FactoryTest_M2DO1_3)
    {
        ui->VehicleFactoryTestPage_button_MDO1_3->setStyleSheet(MY_FACTORYTEST_BTN_UP);
        this->database->HMiCT_FactoryTest_M2DO1_3 = false;
    }else
    {
        ui->VehicleFactoryTestPage_button_MDO1_3->setStyleSheet(MY_FACTORYTEST_BTN_DOWN);
        this->database->HMiCT_FactoryTest_M2DO1_3 = true;
    }
}

void VehicleFactoryTestPage2::on_VehicleFactoryTestPage_button_MDO1_5_pressed()
{
    if(this->database->HMiCT_FactoryTest_M2DO1_5)
    {
        ui->VehicleFactoryTestPage_button_MDO1_5->setStyleSheet(MY_FACTORYTEST_BTN_UP);
        this->database->HMiCT_FactoryTest_M2DO1_5 = false;
    }else
    {
        ui->VehicleFactoryTestPage_button_MDO1_5->setStyleSheet(MY_FACTORYTEST_BTN_DOWN);
        this->database->HMiCT_FactoryTest_M2DO1_5 = true;
    }
}

void VehicleFactoryTestPage2::on_VehicleFactoryTestPage_button_MDO1_8_pressed()
{
    if(this->database->HMiCT_FactoryTest_M2DO1_8)
    {
        ui->VehicleFactoryTestPage_button_MDO1_8->setStyleSheet(MY_FACTORYTEST_BTN_UP);
        this->database->HMiCT_FactoryTest_M2DO1_8 = false;
    }else
    {
        ui->VehicleFactoryTestPage_button_MDO1_8->setStyleSheet(MY_FACTORYTEST_BTN_DOWN);
        this->database->HMiCT_FactoryTest_M2DO1_8 = true;
    }
}

void VehicleFactoryTestPage2::on_VehicleFactoryTestPage_button_MDO1_9_pressed()
{
    if(this->database->HMiCT_FactoryTest_M2DO1_9)
    {
        ui->VehicleFactoryTestPage_button_MDO1_9->setStyleSheet(MY_FACTORYTEST_BTN_UP);
        this->database->HMiCT_FactoryTest_M2DO1_9 = false;
    }else
    {
        ui->VehicleFactoryTestPage_button_MDO1_9->setStyleSheet(MY_FACTORYTEST_BTN_DOWN);
        this->database->HMiCT_FactoryTest_M2DO1_9 = true;
    }
}

void VehicleFactoryTestPage2::on_VehicleFactoryTestPage_button_MDO1_10_pressed()
{
    if(this->database->HMiCT_FactoryTest_M2DO1_10)
    {
        ui->VehicleFactoryTestPage_button_MDO1_10->setStyleSheet(MY_FACTORYTEST_BTN_UP);
        this->database->HMiCT_FactoryTest_M2DO1_10 = false;
    }else
    {
        ui->VehicleFactoryTestPage_button_MDO1_10->setStyleSheet(MY_FACTORYTEST_BTN_DOWN);
        this->database->HMiCT_FactoryTest_M2DO1_10 = true;
    }
}
