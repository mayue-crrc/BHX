...
#ifndef UI_CTRLINPUTMODULE_H
#define UI_CTRLINPUTMODULE_H
...
class Ui_CtrlInputModule
{
public:
    QPushButton *CtrlInputModule_Button_Num0;
    QPushButton *CtrlInputModule_Button_Num1;
    QPushButton *CtrlInputModule_Button_Num2;
    QPushButton *CtrlInputModule_Button_Num3;
    QPushButton *CtrlInputModule_Button_Num4;
    QPushButton *CtrlInputModule_Button_Num6;
    QPushButton *CtrlInputModule_Button_Num5;
    QPushButton *CtrlInputModule_Button_Num7;
    QPushButton *CtrlInputModule_Button_Num8;
    QPushButton *CtrlInputModule_Button_Num9;
    QPushButton *CtrlInputModule_Button_clear;
    QPushButton *CtrlInputModule_Button_confirm;
    QLabel *CtrlInputModule_Label_InputPW;
    QLabel *CtrlInputModule_background;
    QPushButton *CtrlInputModule_Button_Num0_2;

    void setupUi(QWidget *CtrlInputModule)
    {
...
"border-color: rgb(255, 0, 0);\n"
""));
        CtrlInputModule_background->raise();
        CtrlInputModule_Button_Num0->raise();
        CtrlInputModule_Button_Num1->raise();
        CtrlInputModule_Button_Num2->raise();
        CtrlInputModule_Button_Num3->raise();
        CtrlInputModule_Button_Num4->raise();
        CtrlInputModule_Button_Num6->raise();
        CtrlInputModule_Button_Num5->raise();
        CtrlInputModule_Button_Num7->raise();
        CtrlInputModule_Button_Num8->raise();
        CtrlInputModule_Button_Num9->raise();
        CtrlInputModule_Button_clear->raise();
        CtrlInputModule_Button_confirm->raise();
        CtrlInputModule_Label_InputPW->raise();
        CtrlInputModule_Button_Num0_2->raise();

        retranslateUi(CtrlInputModule);

        QMetaObject::connectSlotsByName(CtrlInputModule);
    } // setupUi

    void retranslateUi(QWidget *CtrlInputModule)
    {
        CtrlInputModule->setWindowTitle(QApplication::translate("CtrlInputModule", "Form", 0, QApplication::UnicodeUTF8));
        CtrlInputModule_Button_Num0->setText(QApplication::translate("CtrlInputModule", "0", 0, QApplication::UnicodeUTF8));
        CtrlInputModule_Button_Num1->setText(QApplication::translate("CtrlInputModule", "1", 0, QApplication::UnicodeUTF8));
        CtrlInputModule_Button_Num2->setText(QApplication::translate("CtrlInputModule", "2", 0, QApplication::UnicodeUTF8));
        CtrlInputModule_Button_Num3->setText(QApplication::translate("CtrlInputModule", "3", 0, QApplication::UnicodeUTF8));
        CtrlInputModule_Button_Num4->setText(QApplication::translate("CtrlInputModule", "4", 0, QApplication::UnicodeUTF8));
        CtrlInputModule_Button_Num6->setText(QApplication::translate("CtrlInputModule", "6", 0, QApplication::UnicodeUTF8));
        CtrlInputModule_Button_Num5->setText(QApplication::translate("CtrlInputModule", "5", 0, QApplication::UnicodeUTF8));
        CtrlInputModule_Button_Num7->setText(QApplication::translate("CtrlInputModule", "7", 0, QApplication::UnicodeUTF8));
        CtrlInputModule_Button_Num8->setText(QApplication::translate("CtrlInputModule", "8", 0, QApplication::UnicodeUTF8));
        CtrlInputModule_Button_Num9->setText(QApplication::translate("CtrlInputModule", "9", 0, QApplication::UnicodeUTF8));
        CtrlInputModule_Button_clear->setText(QApplication::translate("CtrlInputModule", "\346\270\205\351\231\244", 0, QApplication::UnicodeUTF8));
        CtrlInputModule_Button_confirm->setText(QApplication::translate("CtrlInputModule", "\347\241\256\350\256\244", 0, QApplication::UnicodeUTF8));
        CtrlInputModule_Label_InputPW->setText(QString());
        CtrlInputModule_background->setText(QString());
        CtrlInputModule_Button_Num0_2->setText(QApplication::translate("CtrlInputModule", "\351\200\200\345\207\272", 0, QApplication::UnicodeUTF8));
    } // retranslateUi

};

namespace Ui {
    class CtrlInputModule: public Ui_CtrlInputModule {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_CTRLINPUTMODULE_H
