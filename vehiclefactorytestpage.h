#ifndef VEHICLEFACTORYTESTPAGE_H
#define VEHICLEFACTORYTESTPAGE_H
...
class VehicleFactoryTestPage : public BasePage
{
    Q_OBJECT

public:
    explicit VehicleFactoryTestPage(QWidget *parent = 0);
    ~VehicleFactoryTestPage();
    void showEvent(QShowEvent *event);
    void updatePage();

private:
    Ui::VehicleFactoryTestPage *ui;
    void resetPisData();
...
private slots:
    ...
    void on_VehicleFactoryTestPage_button_2car_pressed();
...
#endif // VEHICLEFACTORYTESTPAGE_H
