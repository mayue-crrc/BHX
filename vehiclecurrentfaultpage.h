...
class VehicleCurrentFaultPage : public BasePage
{
    Q_OBJECT
...
private:
    ...
    int m_CurrentFault_PageID;
    int m_CurrentFault_MaxPageID;
...
private slots:
    ...
    void on_VehicleCurrentFaultPage_Button_quit_pressed();
    void on_VehicleCurrentFaultPage_Button_PrePage_pressed();
    void on_VehicleCurrentFaultPage_Button_NextPage_pressed();
};
